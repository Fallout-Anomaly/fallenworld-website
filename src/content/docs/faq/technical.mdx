...
3.  **DPI Scaling:** Right-click `Fallout4.exe` in your Stock folder > Properties > Compatibility > Change High DPI settings > Enable **High DPI Scaling Override** and set it to Application.
...
3.  Save the layout and test it in-game at your native resolution.
